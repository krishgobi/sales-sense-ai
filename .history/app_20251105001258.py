...
def admin_panel():
    ...
    stats = {
        ...
        'total_sales': sum(float(sale.get('total_price', 0)) if sale.get('total_price') 
                          else float(sale.get('price', 0)) * float(sale.get('quantity', 0)) 
                          for sale in products_sold.find()),
        'sales_today': sum(float(sale.get('total_price', 0)) if sale.get('total_price')
                          else float(sale.get('price', 0)) * float(sale.get('quantity', 0))
                          for sale in products_sold.find({
    ...
    for user in users_data:
        ...
        user['total_spent'] = sum(float(order.get('total_price', 0)) if order.get('total_price')
                                else float(order.get('price', 0)) * float(order.get('quantity', 0))
    ...
    for sale in products_sold.find({'date': {'$gte': past_week}}):
        ...
        # Calculate total price from either total_price field or price * quantity
        sale_amount = float(sale.get('total_price', 0)) if sale.get('total_price') \
            else float(sale.get('price', 0)) * float(sale.get('quantity', 0))
    ...
    for sale in products_sold.find():
        ...
        sale_amount = sale.get('total_price', 0) or sale.get('price', 0) * sale.get('quantity', 0)
